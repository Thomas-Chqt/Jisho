...
{
    public var title: String = "Nom de la liste" // Title of the dialog
    public var message: String = "" // Dialog message
    public var placeholder: String = "" // Placeholder text for the TextField
    public var textAuDepart: String = ""
    public var accept: String = "OK" // The left-most button label
    public var cancel: String? = "Annuler" // The optional cancel (right-most) button label
  ...
  convenience init(alert: TextAlert)
    {
        ...
        {
            addAction(UIAlertAction(title: secondaryActionTitle, style: .default, handler:
            { _ in
        ...
        addAction(UIAlertAction(title: alert.accept, style: .default)
        { _ in
